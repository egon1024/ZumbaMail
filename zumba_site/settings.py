"""
Django settings for zumba_site project.
...
SECRET_KEY = 'django-insecure-ds1ho4^&*+cgidu57!1%ptmd_he*=w_2ghx!k692#)tnd(@ily'
...
WSGI_APPLICATION = 'zumba_site.wsgi.application'
