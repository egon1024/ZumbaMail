...
function ResidencyReport() {
  ...
  const formatReportText = () => {
    ...
    if (reportData.activities.length === 0) {
      ...
      reportData.activities.forEach(activity => {
        lines.push(`${activity.day_of_week} ${activity.class_type}: ${activity.rochester_count} Rochester residents, ${activity.non_rochester_count} non-Rochester residents`);
      });
    }
  ...
  return (
    <div className="container mt-4">
      <h2 className="mb-4" style={{ color: '#6a359c' }}>Residency Report</h2>
        ...
        <div className="card-body">
          ...
          {!selectedOrgId && !loading && !error && (
            <div className="alert alert-secondary mt-3 mb-0" role="alert">
              ...
              Please select an organization and session to view the residency report.
            </div>
          )}
...
export default ResidencyReport;
